...
class User(BaseModel):
    ...
    role: Mapped[RoleSet] = mapped_column(
        Enum(RoleSet), default=RoleSet.user, nullable=False
    )
    ...
    images: Mapped[list["Image"]] = relationship(
        "Image", back_populates="user", lazy="selectin"
    )
    comments: Mapped[list["Comment"]] = relationship(
        "Comment", back_populates="user", lazy="selectin"
    )
    ratings: Mapped[list["Rating"]] = relationship(
        "Rating", back_populates="user", lazy="selectin"
    )
...
class Image(BaseModel):
    ...
    transformations: Mapped[list["Transformation"]] = relationship(
        "Transformation", back_populates="image", lazy="selectin"
    )
    ratings: Mapped[list["Rating"]] = relationship(
        "Rating", back_populates="image", lazy="selectin"
    )
...
class Comment(BaseModel):
    ...
    image: Mapped["Image"] = relationship(
        "Image", back_populates="comments", lazy="selectin"
    )
...
class Transformation(BaseModel):
    ...
    image: Mapped["Image"] = relationship(
        "Image", back_populates="transformations", lazy="selectin"
    )
...
class Rating(BaseModel):
    ...
    user: Mapped["User"] = relationship(
        "User", back_populates="ratings", lazy="selectin"
    )
    image: Mapped["Image"] = relationship(
        "Image", back_populates="ratings", lazy="selectin"
    )
